...
namespace UIPrimitives
{
	...
	[CustomEditor (typeof(UILineAnimation))]
	class UILineAnimationEditor : UIAnimationEditor
	{
		//Value
		...
		//Target
		protected UILineAnimation myUILineAnimation;
		...
		public override void OnInspectorGUI ()
		{
			...
			/////Target/////
			myUILineAnimation = ((UILineAnimation)target);
			myUIAnimation = myUILineAnimation;
